    ...
    <Card interactive className="flex items-start gap-3.5">
      ...
      <div className="min-w-0 flex-1">
        ...
        {jd.tech_stack.length > 0 && (
          <p className="text-xs text-muted mt-1 truncate">{jd.tech_stack.join(', ')}</p>
        )}
      </div>
    </Card>
  )
  ...
  return (
    <AppShell>
      ...
      <p className="mt-1 text-sm text-muted">
        Every resume and job description you've submitted.
      </p>
      ...
      <section className="mt-8">
        ...
        {!resumes.isLoading && !resumes.isError && resumes.data?.length === 0 && (
          <EmptyState
        ...
        {!resumes.isLoading && !resumes.isError && resumes.data && resumes.data.length > 0 && (
